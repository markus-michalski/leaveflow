...
final class TeamCalendarController extends AbstractController
{
    ...
    public function index(): Response
    {
        ...
        $defaultDepartmentId = $this->resolveDefaultDepartmentId($user, $employee);
    ...
    public function events(Request $request): JsonResponse
    {
        ...
        $leaves = $this->leaveRequestRepository->findApprovedOverlapping(
            $company,
            $start,
            $end,
            $department,
    ...
    private function resolveDefaultDepartmentId(User $user, ?Employee $employee): ?int
    {
