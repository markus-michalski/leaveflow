...
final class Version20260420053912 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE absence_types (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, color VARCHAR(7) NOT NULL, deducts_from_leave TINYINT NOT NULL, requires_approval TINYINT NOT NULL, icon VARCHAR(50) NOT NULL, active TINYINT DEFAULT 1 NOT NULL, company_id INT NOT NULL, INDEX IDX_39F7162B979B1AD6 (company_id), UNIQUE INDEX uniq_absence_type_name_per_company (company_id, name), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
